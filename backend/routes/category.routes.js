...
import { uploadCategoryImage, processCategoryImage } from "../middleware/uploadMedia.js";
import { loadUserData } from "../middleware/loadUserdata.js";


const router = Router();

router.post( "/upload-category",authenticate,authorizeRoles('admin', 'seller'),  uploadCategoryImage, processCategoryImage, uploadCategory);
...
router.patch('/update-category/:id',authenticate,authorizeRoles('admin', 'seller'),  uploadCategoryImage, processCategoryImage, updateCategory);
