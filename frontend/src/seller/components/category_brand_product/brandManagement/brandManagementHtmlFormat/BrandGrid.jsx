...
const BrandGrid = ({ 
  ...
  return (
    <section className="relative px-4 py-8 bg-gradient-to-br from-primary-subtle via-lime-50 to-emerald-100 overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 w-32 h-32 bg-primary-border rounded-full blur-xl animate-pulse"></div>
      ...
      {!loading && brands.length > 0 && (
        <div className='flex items-center w-full flex-col'>
          <h2 className="text-2xl md:text-4xl font-bold text-center mb-8 bg-gradient-to-r from-primary to-emerald-700 bg-clip-text text-transparent">
          Choose Your Brand
        </h2>
          ...
          <div className="text-center mt-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/40 backdrop-blur-sm rounded-full border border-primary-border">
              <div className="w-2 h-2 bg-primary-light rounded-full animate-pulse"></div>
              <span className="text-primary-darker text-sm md:text-base font-medium">
                Selected: {showname}
              </span>
            </div>
          </div>
