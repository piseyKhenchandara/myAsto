      ...
      <article className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto animate-in zoom-in duration-200">
        ...
        <header className="flex items-center justify-between p-6 border-b border-gray-200">
          ...
          <button
            ...
            className={`w-8 h-8 flex items-center justify-center rounded-full ${submit.process 
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-1">
                  This will permanently delete this {name.toLowerCase()}. This action cannot be undone.
                </p>
              </div>
            </div>
          </aside>
