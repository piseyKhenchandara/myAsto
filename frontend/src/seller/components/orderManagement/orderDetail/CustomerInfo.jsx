...
const CustomerInfo = ({ user, shippingAddress, phoneNumber }) => {
  return (
    <div className='bg-white rounded-lg shadow-lg p-4 sm:p-5 space-y-6 h-full border-b-2 border-green-600'>
      {/* Customer Header */}
      <div>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer'>
          <div className='w-14 h-14 sm:w-10 sm:h-10 bg-purple-500 rounded-full flex items-center justify-center text-white font-semibold overflow-hidden mx-auto sm:mx-0'>
